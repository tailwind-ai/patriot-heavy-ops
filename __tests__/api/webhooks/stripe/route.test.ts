  ...
  describe('POST /api/webhooks/stripe', () => {
    describe('Webhook Signature Verification', () => {
      ...
      it('should return 400 when STRIPE_WEBHOOK_SECRET is not configured', async () => {
        ...
        expect(response.status).toBe(400)
        const responseText = await response.text()
        expect(responseText).toContain('STRIPE_WEBHOOK_SECRET is not configured')
    ...
    describe('Unsupported Event Types', () => {
      it('should handle unsupported event types gracefully', async () => {
        ...
        mockStripe.webhooks.constructEvent.mockReturnValue(unsupportedEvent as any)
    ...
    describe('Edge Cases', () => {
      it('should handle missing metadata in checkout session', async () => {
        ...
        mockStripe.webhooks.constructEvent.mockReturnValue(eventWithoutMetadata as any)
      ...
      it('should handle missing subscription ID', async () => {
        ...
        mockStripe.webhooks.constructEvent.mockReturnValue(eventWithoutSubscription as any)
