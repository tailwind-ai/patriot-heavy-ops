...
describe('ServiceRequestOperations', () => {
  ...
  describe('Component Rendering', () => {
    ...
    it('should have correct navigation links', async () => {
      ...
      expect(viewLink).toHaveAttribute('href', '/dashboard/requests/test-request-id')
      expect(editLink).toHaveAttribute('href', '/dashboard/requests/test-request-id/edit')
    })
  ...
  describe('Delete Confirmation Dialog', () => {
    it('should show delete confirmation dialog when delete is clicked', async () => {
      ...
      expect(screen.getByText('Are you sure you want to delete this service request?')).toBeInTheDocument()
      expect(screen.getByText('This action cannot be undone. This will permanently delete your service request "Test Service Request".')).toBeInTheDocument()
    })
    ...
    it('should close dialog when cancel is clicked', async () => {
      ...
      await waitFor(() => {
        expect(screen.queryByText('Are you sure you want to delete this service request?')).not.toBeInTheDocument()
      })
    })
    ...
    it('should include service request title in confirmation message', async () => {
      ...
      expect(screen.getByText('This action cannot be undone. This will permanently delete your service request "Custom Service Request Title".')).toBeInTheDocument()
    })
  })
  ...
  describe('Error Handling', () => {
    ...
    it('should show error toast for 404 not found', async () => {
      ...
      await waitFor(() => {
        expect(mockToast).toHaveBeenCalledWith({
          title: 'Failed to delete service request',
          description: 'Service request not found. It may have already been deleted.',
          variant: 'destructive',
        })
      })
    })
    ...
    it('should show network error toast for fetch failures', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Delete service request error:', expect.any(Error))
  ...
  describe('Edge Cases', () => {
    it('should handle service request with special characters in title', async () => {
      ...
      expect(screen.getByText('This action cannot be undone. This will permanently delete your service request "Request with "quotes" & <symbols>".')).toBeInTheDocument()
    })
    ...
    it('should handle very long service request titles', async () => {
      ...
      expect(screen.getByText(`This action cannot be undone. This will permanently delete your service request "${'A'.repeat(200)}".`)).toBeInTheDocument()
    })
    ...
    it('should handle empty service request title', async () => {
      ...
      expect(screen.getByText('This action cannot be undone. This will permanently delete your service request "".')).toBeInTheDocument()
    })
