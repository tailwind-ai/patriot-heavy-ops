...
describe("UserAccountNav", () => {
  ...
  describe("Null Safety - User Name", () => {
    ...
    it("should not display name when user.name is null (handles undefined via optional chaining)", async () => {
      const user = { name: null, email: "test@example.com", image: null }
      const userInstance = userEvent.setup()
  ...
  describe("Null Safety - User Email", () => {
    ...
    it("should render without crashing when user.email is null (handles undefined via optional chaining)", () => {
      const user = { name: "Test User", email: null, image: null }
  ...
  describe("Null Safety - All Fields Null/Undefined", () => {
    ...
    it("should render gracefully when all user fields are null (handles undefined via optional chaining)", () => {
      const user = { name: null, email: null, image: null }
