...
# These rules SUPERSEDE all general coding practices

# FAILURE TO FOLLOW = IMMEDIATE WORK STOPPAGE

## Validation Protocol - RESPOND WITH THIS FORMAT:\*\*

When starting work, respond with: "Following cursorrules.md v2.0, current mode: [MODE], Ana status: [STATUS], Tod TODOs: [COUNT]"
...
**Full Validation**: `docker-compose exec app npx tsc --noEmit && npx eslint . --quiet`
...
- [ ] **CRITICAL**: Run `docker-compose exec app npx tsc --noEmit && npx eslint . --quiet`
