...
function t(r) {
    ...
    }(r), t = r.conflictingClassGroups, l = r.conflictingClassGroupModifiers, s = void 0 === l ? {} : l;
    return {
        getClassGroupId: function(r) {
            var t = r.split(o);
            return "" === t[0] && 1 !== t.length && t.shift(), n(t, e) || function(r) {
                if (i.test(r)) {
                    var e = i.exec(r)[1], o = e?.substring(0, e.indexOf(":"));
...
function n(r, e) {
    ...
    var t = e.nextPart.get(r[0]), i = t ? n(r.slice(1), t) : void 0;
    if (i) return i;
...
function d(r) {
    ...
    return function(r) {
        ...
        var p = 0 === a.length ? r : r.substring(s), f = p.startsWith(c);
        return {
            modifiers: a,
...
function p() {
    ...
    var i, a, l, p = function(r) {
        var e = o[0], n = o.slice(1).reduce(function(r, e) {
            return e(r);
        }, e());
        return i = function(r) {
            return {
        ...
        }(n), a = i.cache.get, l = i.cache.set, p = f, f(r);
    };
    function f(r) {
        var e = a(r);
        if (e) return e;
        var o = function(r, e) {
            ...
            return r.trim().split(u).map(function(r) {
                var e = o(r), n = e.modifiers, i = e.hasImportantModifier, a = e.baseClassName, l = e.maybePostfixModifierPosition, s = t(l ? a.substring(0, l) : a), d = Boolean(l);
                if (!s) {
                    if (!l) return {
                        isTailwindClass: !1,
                        originalClassName: r
...
var b = /^\[(?:([a-z-]+):)?(.+)\]$/i, m = /^\d+\/\d+$/, g = new Set([
    ...
    "full",
    "screen"
]), h = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, v = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, y = /^-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/;
function x(r) {
...
function q() {
    var r = f("colors"), e = f("spacing"), o = f("blur"), t = f("brightness"), n = f("borderColor"), i = f("borderRadius"), a = f("borderSpacing"), l = f("borderWidth"), s = f("contrast"), c = f("grayscale"), d = f("hueRotate"), u = f("invert"), p = f("gap"), b = f("gradientColorStops"), m = f("gradientColorStopPositions"), g = f("inset"), h = f("margin"), v = f("opacity"), y = f("padding"), T = f("saturate"), O = f("scale"), E = f("sepia"), _ = f("skew"), W = f("space"), $ = f("translate"), R = function() {
        return [
            "auto",
            I,
            e
...
var B = Object.prototype.hasOwnProperty, D = new Set([
    "string",
    "number",
    "boolean"
]);
...
}, __webpack_unused_export__ = f, __webpack_unused_export__ = q, __webpack_unused_export__ = V, __webpack_unused_export__ = L, __webpack_unused_export__ = r, exports.m6 = U, __webpack_unused_export__ = R; //# sourceMappingURL=tailwind-merge.cjs.production.min.js.map
